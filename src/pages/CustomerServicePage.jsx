...
const faqs = [
  ...
  ['Kan ik mijn bestelling wijzigen?', 'Neem direct contact op met klantenservice, dan helpen we zo snel mogelijk.'],
...
export const CustomerServicePage = () => {
  ...
  return (
    <section className="container section customer-service">
      ...
      <p>Heb je een vraag? Stel je vraag en we reageren meestal binnen 24 uur.</p>
      ...
      <div className="service-grid">
        ...
        >
          ...
          {sent && <p className="success">Bedankt! We nemen snel contact met je op.</p>}
        </form>
